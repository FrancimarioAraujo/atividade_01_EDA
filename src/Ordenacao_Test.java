...
public class Ordenacao_Test {
    ...
    public void testChecaVetorOrdenado() {
        assertFalse(ordenacao.checaVetorOrdenado(filmesDesordenados)); // O vetor original de filmes, para os testes,
                                                                       // não deve estar ordenado
    }
    ...
    // assertTrue(ordenacao.checaVetorOrdenado(filmesDesordenadosClonados)); // O
    // vetor clonado deve estar ordenado
    // // após executar o método
    // assertFalse(ordenacao.checaVetorOrdenado(filmesDesordenados)); // O vetor
    // original não deve estar ordenado após
    // // executar o método
    // }
    ...
    public void testSelectionSort() {
        ...
        assertTrue(ordenacao.checaVetorOrdenado(filmesDesordenadosClonados)); // O vetor clonado deve estar ordenado
                                                                              // após executar o método
        assertFalse(ordenacao.checaVetorOrdenado(filmesDesordenados)); // O vetor original não deve estar ordenado após
                                                                       // executar o método
    }
